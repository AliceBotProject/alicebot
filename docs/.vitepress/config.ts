...
function getSidebarItem(file: string): DefaultTheme.SidebarItem {
  ...
  // further processing, not done:
  // https://github.com/vuepress/vuepress-next/blob/d7fdf646b3fc4faa242d2df7933080ad713a244c/packages/%40vuepress/markdown/src/markdown.ts
  return {
    text: match[1].trim(),
    link: file
  }
