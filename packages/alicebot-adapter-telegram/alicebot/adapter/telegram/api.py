...
class TelegramAPI(TelegramAPIBase, ABC):
    ...
    async def get_user_profile_audios(
        ...
        return await self.call_api(
            ...
            response_type=UserProfileAudios,
            user_id=user_id,
            offset=offset,
            limit=limit,
        )
    ...
    async def get_managed_bot_token(self, *, user_id: int) -> str:
        return await self.call_api(
            "getManagedBotToken", response_type=str, user_id=user_id
        )

    async def replace_managed_bot_token(self, *, user_id: int) -> str:
        return await self.call_api(
            "replaceManagedBotToken", response_type=str, user_id=user_id
        )
    ...
    async def set_my_profile_photo(self, *, photo: InputProfilePhoto) -> bool:
        return await self.call_api("setMyProfilePhoto", response_type=bool, photo=photo)

    async def remove_my_profile_photo(self) -> bool:
        return await self.call_api("removeMyProfilePhoto", response_type=bool)
    ...
    async def save_prepared_keyboard_button(
        ...
        return await self.call_api(
            ...
            response_type=PreparedKeyboardButton,
            user_id=user_id,
            button=button,
        )
    ...
    async def get_my_star_balance(self) -> StarAmount:
        return await self.call_api("getMyStarBalance", response_type=StarAmount)
